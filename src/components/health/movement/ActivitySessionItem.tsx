...
interface ActivitySessionItemProps {
...
export function ActivitySessionItem({
    ...
    return (
        <div className="p-4 pl-8 border border-white/5 bg-[#070707] hover:border-white/10 transition-all space-y-3 relative group rounded-none">
