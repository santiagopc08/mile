...
export function ChamferedPanel({
    ...
    return (
        <motion.div
            ...
            className={`group relative overflow-hidden bg-[#0a070c]/92 backdrop-blur-xl border p-4 transition-all duration-300 ${staggerIndex !== undefined ? 'stagger-item' : ''} ${className}`}
            style={{
