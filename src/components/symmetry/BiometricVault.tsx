...
export const BiometricVault = () => {
    ...
    const engineStats = useMemo(() => calculateEngineStats(state.cycles), [state.cycles]);
    ...
    const getPartnerTranslationMessage = () => getPartnerTranslation(engineStats);
