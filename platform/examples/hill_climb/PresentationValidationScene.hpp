#ifndef PLATFORM_EXAMPLES_HILL_CLIMB_PRESENTATION_VALIDATION_SCENE_HPP
#define PLATFORM_EXAMPLES_HILL_CLIMB_PRESENTATION_VALIDATION_SCENE_HPP
...
// Presentation Framework Modules
...
namespace platform
{
    class PresentationValidationScene : public Scene
    {
    public:
        PresentationValidationScene();
        ~PresentationValidationScene() override = default;
        ...
        [[nodiscard]] ScreenManager &GetScreenManager() { return m_screenManager; }
        [[nodiscard]] NotificationManager &GetNotificationManager() { return m_notificationManager; }
        [[nodiscard]] ThemeManager &GetThemeManager() { return m_themeManager; }
...
#endif // PLATFORM_EXAMPLES_HILL_CLIMB_PRESENTATION_VALIDATION_SCENE_HPP
